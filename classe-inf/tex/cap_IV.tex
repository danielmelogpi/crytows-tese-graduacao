...
\begin{figure}[H]
 ...
 \caption{Exemplos de diversos tipos de token, como aqueles em formato de pendrive, cartão criptográfico e token desconectado, gerador de código secreto com e sem entrada de senha pessoal}
 \label{fig:exemploFig2}
\end{figure}
